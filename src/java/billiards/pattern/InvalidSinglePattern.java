 ...
 * <b>May 08, 2026</b>
 * <p>
 *     <i>InvalidSinglePattern</i> represents a single code sequence pattern that is in an invalid state or
...
public enum InvalidSinglePattern {
    ...
    // NOTE: This pattern is very common across "invalid" types; abstracting it into its own interface
    // could be good.
    private final String message;

    private InvalidSinglePattern(final String message) {
