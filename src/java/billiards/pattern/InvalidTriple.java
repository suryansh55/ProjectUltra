...
public enum InvalidTriple {
    ...
    // NOTE: To be completely sure a triple is valid we should also check whether the stables are
    // boundaries to the unstable.

    private final String message;

    private InvalidTriple(final String message) {
